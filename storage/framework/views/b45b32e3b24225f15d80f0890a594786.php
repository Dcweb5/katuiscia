...
<div class="dashboard-content">
  <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:var(--space-2xl);">
    <div>
      <h1 class="page-title" style="margin-bottom:4px;">Bonjour, <?php echo e(auth()->user()->firstname ?? 'Admin'); ?></h1>
      <p class="page-subtitle" style="margin:0;">Vue d'ensemble de votre boutique KATUISCIA.</p>
    </div>
    <span style="font-size:var(--text-xs); color:var(--color-text-muted);"><?php echo e(now()->format('d F Y')); ?></span>
  </div>
    ...
    <div class="card stat-card stat-card-animated">
      <div style="display:flex; align-items:center; gap:var(--space-md);">
        ...
        <div>
          ...
          <span class="stat-value count-up" data-target="<?php echo e($stats['total_products']); ?>" style="font-size:2rem;">0</span>
        </div>
      </div>
      <a href="<?php echo e(url('admin/produits')); ?>" style="font-size:10px; color:var(--color-warm); margin-top:4px; display:block;">Voir tous →</a>
    </div>
    <div class="card stat-card stat-card-animated">
      <div style="display:flex; align-items:center; gap:var(--space-md);">
        ...
        <div>
          ...
          <span class="stat-value count-up" data-target="<?php echo e($stats['total_categories']); ?>" style="font-size:2rem;">0</span>
        </div>
      </div>
      <a href="<?php echo e(url('admin/categories')); ?>" style="font-size:10px; color:var(--color-warm); margin-top:4px; display:block;">Gérer →</a>
    </div>
    <div class="card stat-card stat-card-animated">
      <div style="display:flex; align-items:center; gap:var(--space-md);">
        ...
        <div>
          ...
          <span class="stat-value count-up" data-target="<?php echo e($stats['total_collections']); ?>" style="font-size:2rem;">0</span>
        </div>
      </div>
      <a href="<?php echo e(url('admin/collections')); ?>" style="font-size:10px; color:var(--color-warm); margin-top:4px; display:block;">Gérer →</a>
    </div>
    <div class="card stat-card stat-card-animated">
      <div style="display:flex; align-items:center; gap:var(--space-md);">
        ...
        <div>
          ...
          <span class="stat-value count-up" data-target="<?php echo e($stats['total_orders']); ?>" style="font-size:2rem;">0</span>
        </div>
      </div>
      <a href="<?php echo e(url('admin/commandes')); ?>" style="font-size:10px; color:var(--color-warm); margin-top:4px; display:block;">Voir toutes →</a>
    </div>
    <div class="card stat-card stat-card-animated">
      <div style="display:flex; align-items:center; gap:var(--space-md);">
        ...
        <div>
          ...
          <span class="stat-value count-up" data-target="<?php echo e($stats['total_users']); ?>" style="font-size:2rem;">0</span>
        </div>
      </div>
      <a href="<?php echo e(url('admin/utilisateurs')); ?>" style="font-size:10px; color:var(--color-warm); margin-top:4px; display:block;">Voir tous →</a>
    </div>
    <div class="card stat-card stat-card-animated">
      <div style="display:flex; align-items:center; gap:var(--space-md);">
        ...
        <div>
          ...
          <span class="stat-value count-up" data-target="<?php echo e($visitorsToday); ?>" style="font-size:2rem;">0</span>
        </div>
      </div>
  ...
  <div style="display:grid; grid-template-columns:1fr 2fr; gap:var(--space-xl);">
    ...
    <div class="card" style="padding:var(--space-xl);">
      ...
      <div style="display:flex; flex-direction:column; gap:var(--space-sm);">
        ...
        <a href="<?php echo e(route('admin.categories.index')); ?>" class="quick-action-card">
        ...
        <a href="<?php echo e(url('admin/commandes')); ?>" class="quick-action-card">
        ...
        <a href="<?php echo e(url('admin/utilisateurs')); ?>" class="quick-action-card">
        ...
        <a href="<?php echo e(url('/')); ?>" target="_blank" class="quick-action-card">
    ...
    <div class="card" style="padding:var(--space-xl);">
      ...
      <?php $recentUsers = $recentUsers ?? \App\Models\User::latest()->take(5)->get(); ?>
      ...
      <div style="display:flex; flex-direction:column; gap:var(--space-md);">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; padding:var(--space-sm) 0; border-bottom:1px solid var(--color-border);">
          <div style="display:flex; align-items:center; gap:var(--space-sm);">
            <div style="width:36px; height:36px; border-radius:50%; background:<?php echo e($u->is_admin ? 'var(--color-dark)' : 'var(--color-warm)'); ?>; color:white; display:flex; align-items:center; justify-content:center; font-size:12px; font-weight:bold;">
              <?php echo e(substr($u->firstname ?? 'U', 0, 1)); ?><?php echo e(substr($u->lastname ?? '', 0, 1)); ?>

            </div>
            <div>
              <strong style="font-size:var(--text-sm);"><?php echo e($u->firstname); ?> <?php echo e($u->lastname); ?></strong>
              <br><span style="font-size:11px; color:var(--color-text-muted);"><?php echo e($u->email); ?></span>
            </div>
          </div>
          <span style="font-size:10px; text-transform:uppercase; letter-spacing:0.05em; <?php echo e($u->is_admin ? 'color:var(--color-dark); font-weight:600;' : 'color:var(--color-text-muted);'); ?>"><?php echo e($u->is_admin ? '👑 Admin' : '👤 Client'); ?></span>
        </div>
...
new Chart(revenueCtx, {
  ...
  data: {
    ...
    datasets: [{
      label: 'Revenus (€)',
      data: <?php echo json_encode(array_values($revenueData), 15, 512) ?>,
      backgroundColor: ctx => {
...
new Chart(topCtx, {
  type: 'doughnut',
  data: {
    labels: <?php echo json_encode($topProducts->pluck('product_name')->toArray(), 15, 512) ?>,
    datasets: [{
      data: <?php echo json_encode($topProducts->pluck('qty')->toArray(), 15, 512) ?>,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>