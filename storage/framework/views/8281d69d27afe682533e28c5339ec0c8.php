...
<div class="dashboard-content">
  ...
  <form method="POST" action="<?php echo e(route('admin.products.store')); ?>" enctype="multipart/form-data" style="max-width:800px;">
    <?php echo csrf_field(); ?>
    ...
    <div class="card" style="margin-bottom:var(--space-xl);">
      ...
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:var(--space-md);">
        <div class="admin-form-group" style="grid-column:1/-1;">
          ...
          <input type="text" name="name" class="admin-input" value="<?php echo e(old('name')); ?>" placeholder="Ex: Nectar Lumineux" required>
        </div>
        ...
        <div class="admin-form-group">
          ...
          <select name="badge" class="admin-input">
            ...
            <option value="Best-seller" <?php if(old('badge')=='Best-seller'): echo 'selected'; endif; ?>>Best-seller</option>
            <option value="Nouveau" <?php if(old('badge')=='Nouveau'): echo 'selected'; endif; ?>>Nouveau</option>
            <option value="Promo" <?php if(old('badge')=='Promo'): echo 'selected'; endif; ?>>Promo</option>
            <option value="TOP" <?php if(old('badge')=='TOP'): echo 'selected'; endif; ?>>TOP</option>
          </select>
        </div>

        <div class="admin-form-group">
          <label class="admin-label">Prix (€) *</label>
          <input type="number" name="price" class="admin-input" value="<?php echo e(old('price')); ?>" placeholder="125.00" step="0.01" required>
        </div>

        <div class="admin-form-group">
          <label class="admin-label">Prix barré (€)</label>
          <input type="number" name="sale_price" class="admin-input" value="<?php echo e(old('sale_price')); ?>" placeholder="150.00" step="0.01">
        </div>

        <div class="admin-form-group">
          <label class="admin-label">Stock</label>
          <input type="number" name="stock" class="admin-input" value="<?php echo e(old('stock', 0)); ?>" min="0">
        </div>

        <div class="admin-form-group">
          <label class="admin-label">SKU</label>
          <input type="text" name="sku" class="admin-input" value="<?php echo e(old('sku')); ?>" placeholder="Ex: NL-001">
        </div>

        <div class="admin-form-group">
          <label class="admin-label">Contenance</label>
          <input type="text" name="size" class="admin-input" value="<?php echo e(old('size')); ?>" placeholder="Ex: 30ml, 50g">
        </div>
        ...
        <div class="admin-form-group">
          ...
          <select name="need" class="admin-input">
            <option value="">—</option>
            <option value="hydratation" <?php if(old('need')=='hydratation'): echo 'selected'; endif; ?>>Hydratation</option>
            <option value="eclat" <?php if(old('need')=='eclat'): echo 'selected'; endif; ?>>Éclat</option>
            <option value="restauration" <?php if(old('need')=='restauration'): echo 'selected'; endif; ?>>Restauration</option>
          </select>
        </div>
      ...
      <div class="admin-form-group" style="margin-top:var(--space-md);">
        ...
        <textarea name="description" class="admin-input" rows="2" placeholder="Ex: Huile Visage Réparatrice..." style="resize:vertical;"><?php echo e(old('description')); ?></textarea>
      </div>

      <div class="admin-form-group">
        <label class="admin-label">Description détaillée</label>
        <textarea name="long_description" class="admin-input" rows="4" placeholder="Description complète du produit..." style="resize:vertical;"><?php echo e(old('long_description')); ?></textarea>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:var(--space-xl);">
      ...
      <div style="display:flex; flex-wrap:wrap; gap:var(--space-sm);">
        ...
        <label style="display:flex; align-items:center; gap:6px; padding:8px 14px; border:1px solid var(--color-border); border-radius:var(--radius-sm); cursor:pointer; font-size:var(--text-sm); transition:all 0.2s;">
          <input type="checkbox" name="categories[]" value="<?php echo e($category->id); ?>" style="accent-color:var(--color-warm);">
    ...
    <div style="display:flex; gap:var(--space-sm); justify-content:flex-end;">
      <a href="<?php echo e(route('admin.products.index')); ?>" style="padding:10px 20px; border:1px solid var(--color-border); border-radius:var(--radius-sm); background:transparent; cursor:pointer; font-size:var(--text-sm); text-decoration:none; color:inherit;">Annuler</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\admin\products\create.blade.php ENDPATH**/ ?>