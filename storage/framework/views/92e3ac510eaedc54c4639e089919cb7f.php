<?php $__env->startSection('title', 'Gestion des Sections'); ?>
    ...
    <div class="dashboard-content">
      ...
      <div class="section-panel" id="panel-selection" style="display:none;">
        <div class="card">
          ...
          <p style="font-size:var(--text-sm); color:var(--color-text-muted); margin-bottom:var(--space-lg);">Cette section affiche les collections de produits (packs). Gérez vos collections depuis la page <a href="<?php echo e(url('admin-collections')); ?>" style="color:var(--color-warm); font-weight:500;">Collections</a>.</p>
