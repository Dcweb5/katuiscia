<?php $__env->startSection('title', 'Grossiste — Devenez Partenaire'); ?>
    ...
    <section class="landing-section landing-section--alt" id="video">
      ...
      <div class="landing-video">
        <div class="landing-video__wrapper" id="video-container">
          <img src="<?php echo e(asset('assets/images/hero-slide-2.jpg')); ?>" alt="Présentation du programme grossiste KATUISCIA" class="landing-video__placeholder">
      ...
      <div class="landing-booking">
        ...
        <div class="form-wrapper">
          ...
          <form method="POST" action="<?php echo e(route('appointment.store')); ?>" class="booking-form">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="source" value="<?php echo e($source ?? 'grossiste'); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
              ...
              <textarea name="message" class="form-textarea" placeholder="Boutique physique, institut, e-commerce, salon..."><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views/pages/grossiste.blade.php ENDPATH**/ ?>