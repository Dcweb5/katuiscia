...
<aside class="dashboard-sidebar" id="sidebar">
  <div class="sidebar-header">
    <a href="<?php echo e(url('admin')); ?>" style="display:flex; align-items:center; gap:var(--space-sm); text-decoration:none;">
      <img src="<?php echo e(asset('assets/images/K ICONE.png')); ?>" alt="Katuiscia" class="sidebar-logo-icon sidebar-logo-mobile">
  ...
  <nav class="sidebar-nav">
    <a href="<?php echo e(url('admin')); ?>" class="sidebar-link" data-page="admin">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
      Vue d'ensemble
    </a>
    <a href="<?php echo e(url('admin/produits')); ?>" class="sidebar-link" data-page="admin-produits">
    ...
    <a href="<?php echo e(url('admin/categories')); ?>" class="sidebar-link" data-page="admin-categories">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z"/></svg>
      Catégories
    </a>
    <a href="<?php echo e(url('admin/collections')); ?>" class="sidebar-link" data-page="admin-collections">
    ...
    <a href="<?php echo e(url('admin/sections')); ?>" class="sidebar-link" data-page="admin-sections">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 4h16"/><path d="M4 10h16"/><path d="M4 16h16"/><path d="M4 22h16"/></svg>
      Sections
    </a>
    <a href="<?php echo e(url('admin/blog')); ?>" class="sidebar-link" data-page="admin-blog">
    ...
    <a href="<?php echo e(url('admin/commandes')); ?>" class="sidebar-link" data-page="admin-commandes">
    ...
    <a href="<?php echo e(url('admin/contacts')); ?>" class="sidebar-link" data-page="admin-contacts">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
      Messages
    </a>
    <a href="<?php echo e(url('admin/chat')); ?>" class="sidebar-link" data-page="admin-messages">
    ...
    <a href="<?php echo e(url('admin/reviews')); ?>" class="sidebar-link" data-page="admin-reviews">
    ...
    <a href="<?php echo e(url('admin/rendezvous')); ?>" class="sidebar-link" data-page="admin-rendezvous">
    ...
    <a href="<?php echo e(url('admin/utilisateurs')); ?>" class="sidebar-link" data-page="admin-utilisateurs">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
      Utilisateurs
    </a>
    <a href="<?php echo e(url('admin/coupons')); ?>" class="sidebar-link" data-page="admin-coupons">
    ...
    <a href="<?php echo e(url('admin/funnels')); ?>" class="sidebar-link" data-page="admin-funnels">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M22 3 2 3 10 12.46V19l4 2v-8.54L22 3z"/></svg>
      Marketing
    </a>
    <a href="<?php echo e(url('admin/finances')); ?>" class="sidebar-link" data-page="admin-finances">
    ...
    <a href="<?php echo e(url('admin/analytics')); ?>" class="sidebar-link" data-page="admin-analytics">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/></svg>
      Analytics
    </a>

    <!-- Déconnexion admin -->
    <form method="POST" action="<?php echo e(url('deconnexion')); ?>" style="margin-top:auto;">
      <?php echo csrf_field(); ?>
  ...
  <div class="sidebar-footer">
    ...
    <div class="sidebar-admin-badge">
      <div class="sidebar-admin-avatar" style="background:var(--color-warm);">
        <?php echo e(substr(Auth::user()->firstname ?? 'A', 0, 1)); ?><?php echo e(substr(Auth::user()->lastname ?? 'D', 0, 1)); ?>

      </div>
      <div class="sidebar-admin-info">
        <span class="sidebar-admin-name"><?php echo e(Auth::user()->firstname ?? 'Admin'); ?> <?php echo e(Auth::user()->lastname ?? ''); ?></span>
        <span class="sidebar-admin-role">Administrateur</span>
      </div>
    </div>
  </div>
</aside>
<?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\components\admin-sidebar.blade.php ENDPATH**/ ?>