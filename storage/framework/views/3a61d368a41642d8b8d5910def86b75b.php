...
<div class="dashboard-content">
  <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:var(--space-2xl);flex-wrap:wrap;gap:1rem;">
    ...
    <div style="display:flex;gap:0.5rem;">
      <a href="?period=7" class="btn-primary" style="font-size:12px;text-decoration:none;<?php echo e($days == 7 ? '' : 'background:transparent;color:var(--color-text);border-color:var(--color-border);'); ?>">7 jours</a>
      <a href="?period=30" class="btn-primary" style="font-size:12px;text-decoration:none;<?php echo e($days == 30 ? '' : 'background:transparent;color:var(--color-text);border-color:var(--color-border);'); ?>">30 jours</a>
      <a href="?period=90" class="btn-primary" style="font-size:12px;text-decoration:none;<?php echo e($days == 90 ? '' : 'background:transparent;color:var(--color-text);border-color:var(--color-border);'); ?>"><?php echo e($days == 90 ? '90 jours' : '90 jours'); ?></a>
    </div>
  </div>
  ...
  <div class="stats-grid" style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem;margin-bottom:var(--space-xl);">
    <div class="card stat-card" style="padding:1.25rem;">
      ...
      <span class="stat-value"><?php echo e(number_format($uniqueVisitors, 0, ',', ' ')); ?></span>
    </div>
    <div class="card stat-card" style="padding:1.25rem;">
      <span class="stat-title">Pages vues</span>
      <span class="stat-value"><?php echo e(number_format($totalViews, 0, ',', ' ')); ?></span>
    </div>
    <div class="card stat-card" style="padding:1.25rem;">
      <span class="stat-title">Pages / session</span>
      <span class="stat-value"><?php echo e($avgPages); ?></span>
    </div>
    <div class="card stat-card" style="padding:1.25rem;">
      <span class="stat-title">Taux de conversion</span>
      <span class="stat-value"><?php echo e($uniqueVisitors > 0 ? round((\App\Models\Order::where('created_at', '>=', now()->subDays($days))->count() / $uniqueVisitors) * 100, 1) : 0); ?>%</span>
    </div>
  </div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-xl);">
    <div class="card" style="padding:0;overflow:hidden;">
      ...
      <table class="admin-table">
        ...
        <tbody>
          ...
          <tr><td style="font-size:13px;max-width:300px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="<?php echo e($p->url); ?>"><?php echo e($p->short); ?></td><td><?php echo e($p->total); ?></td><td><?php echo e($p->pct); ?>%</td></tr>
    ...
    <div class="card" style="padding:0;overflow:hidden;">
      ...
      <table class="admin-table">
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $referers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php
          ...
          ?>
          <tr><td style="font-size:13px;"><?php echo e($label); ?></td><td><?php echo e($r->total); ?></td></tr>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
new Chart(document.getElementById('dailyChart'), {
  type: 'bar',
  data: {
    labels: <?php echo json_encode($daily->pluck('d')->toArray(), 15, 512) ?>,
    datasets: [{
      label: 'Visites',
      data: <?php echo json_encode($daily->pluck('count')->toArray(), 15, 512) ?>,
...
new Chart(document.getElementById('deviceChart'), {
  ...
  data: {
    ...
    datasets: [{
      data: [<?php echo e($devices['Mobile']); ?>, <?php echo e($devices['Desktop']); ?>, <?php echo e($devices['Tablette']); ?>],
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\admin\analytics\index.blade.php ENDPATH**/ ?>