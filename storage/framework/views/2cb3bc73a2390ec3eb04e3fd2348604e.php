      ...
      <div class="max-w-site mx-auto px-4 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div class="reveal-k-k">
            <img src="<?php echo e(asset('assets/images/biodiv-hero.png')); ?>" alt="Produit KATUISCIA dans un pot en verre" class="w-full h-[400px] md:h-[500px] object-cover rounded-2xl shadow-xl">
          </div>
