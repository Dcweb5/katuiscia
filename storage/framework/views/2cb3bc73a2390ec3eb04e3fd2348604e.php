<?php $__env->startSection('title', 'Emballage Durable — KATUISCIA'); ?>
      ...
      <div class="max-w-site mx-auto px-4 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div class="reveal-k-k">
            <img src="<?php echo e(asset('assets/images/biodiv-hero.webp')); ?>" alt="Produit KATUISCIA dans un pot en verre" class="w-full h-[400px] md:h-[500px] object-cover rounded-2xl shadow-xl">
          </div>
          <div class="reveal-k-k delay-1 space-y-6">
            ...
            <div class="pt-4">
              <a href="<?php echo e(url('boutique')); ?>" class="btn-katuiscia-filled inline-block py-4 px-10 text-sm tracking-widest uppercase font-semibold">Découvrir nos soins</a>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\pages\valeurs-emballage-durable.blade.php ENDPATH**/ ?>