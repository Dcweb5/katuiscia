...
<div class="auth-split">
  <div class="auth-image">
    ...
    <div class="auth-slideshow">
      ...
      <div class="auth-slide"><div class="auth-slide__icon">🎉</div><h2 class="auth-slide__title">Mot de passe réinitialisé</h2><p class="auth-slide__text">Votre mot de passe a bien été modifié.</p><a href="<?php echo e(url('connexion')); ?>" class="auth-slide__cta">Se connecter</a></div>
    </div>
  ...
  <div class="auth-form-container">
    <a href="<?php echo e(url('connexion')); ?>" class="back-home"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="m15 18-6-6 6-6"/></svg>Retour</a>
    <div class="auth-form fade-in-up delay-1">
      <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('assets/images/K LOGO.png')); ?>" alt="KATUISCIA" class="auth-logo"></a>
      ...
      <form method="POST" action="<?php echo e(url('reinitialisation')); ?>">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="token" value="<?php echo e($token ?? ''); ?>">
        <input type="hidden" name="email" value="<?php echo e(request('email')); ?>">
        <div class="form-group fade-in-up delay-2">
          <label class="form-label">Adresse e-mail</label>
          <input type="email" class="form-input" value="<?php echo e(request('email')); ?>" readonly style="background:var(--color-gray); cursor:not-allowed;">
        </div>
      ...
      <p class="auth-footer fade-in-up delay-5"><a href="<?php echo e(url('connexion')); ?>" style="text-transform:uppercase; letter-spacing:0.05em; font-size:12px;">← Retour à la connexion</a></p>
    </div>
  </div>
</div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>