...
<?php $__env->startSection('description', 'Créez votre compte Katuiscia et rejoignez le Club Privilège.'); ?>
...
<div class="auth-split">
  ...
  <div class="auth-form-container" style="order:1;">
    ...
    <div class="auth-form fade-in-up delay-1" style="max-width:440px;">
      ...
      <form method="POST" action="<?php echo e(url('inscription')); ?>">
        ...
        <div style="display:flex; gap:var(--space-sm);">
          <div class="form-group fade-in-up delay-2" style="flex:1;">
            ...
            <input type="text" id="firstname" name="firstname" class="form-input" placeholder="Sophie" value="<?php echo e(old('firstname')); ?>" required>
          </div>
          <div class="form-group fade-in-up delay-2" style="flex:1;">
            <label class="form-label" for="lastname">Nom *</label>
            <input type="text" id="lastname" name="lastname" class="form-input" placeholder="Dubois" value="<?php echo e(old('lastname')); ?>" required>
          </div>
        </div>

        <div class="form-group fade-in-up delay-3">
          <label class="form-label" for="email">Adresse e-mail *</label>
          <input type="email" id="email" name="email" class="form-input" placeholder="votre@email.com" value="<?php echo e(old('email')); ?>" required autocomplete="email">
        </div>

        <div class="form-group fade-in-up delay-3">
          <label class="form-label" for="phone">Numéro de téléphone</label>
          <input type="tel" id="phone" name="phone" class="form-input" placeholder="+33 6 12 34 56 78" value="<?php echo e(old('phone')); ?>">
        </div>

        <div style="display:flex; gap:var(--space-sm);">
          <div class="form-group fade-in-up delay-3" style="flex:1;">
            <label class="form-label" for="city">Ville</label>
            <input type="text" id="city" name="city" class="form-input" placeholder="Paris" value="<?php echo e(old('city')); ?>">
          </div>
          <div class="form-group fade-in-up delay-3" style="flex:1;">
            <label class="form-label" for="postal_code">Boîte Postale</label>
            <input type="text" id="postal_code" name="postal_code" class="form-input" placeholder="BP 12345" value="<?php echo e(old('postal_code')); ?>">
          </div>
        </div>
        ...
        <div class="form-group fade-in-up delay-4">
          ...
          <select id="country" name="country" class="form-input">
            ...
            <option value="FR" <?php if(old('country', 'FR')=='FR'): echo 'selected'; endif; ?>>France</option>
      ...
      <p class="auth-footer fade-in-up delay-5">
        Déjà un compte ? <a href="<?php echo e(url('connexion')); ?>">Se connecter</a>
      </p>
    </div>
  </div>
  ...
  <div class="auth-image" style="order:2;">
    <img src="<?php echo e(asset('assets/images/hero-1.webp')); ?>" alt="Ambiance Katuiscia" class="bg" onerror="this.style.display='none';">
    <div class="auth-slideshow">
      <div class="auth-slide active" data-slide="0">
        ...
        <a href="<?php echo e(url('boutique')); ?>" class="auth-slide__cta">Notre philosophie</a>
      </div>
      ...
      <div class="auth-slide" data-slide="2">
        ...
        <a href="<?php echo e(url('boutique')); ?>" class="auth-slide__cta">Voir la boutique</a>
      </div>
    </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\auth\register.blade.php ENDPATH**/ ?>