...
<?php $__env->startSection('description', 'Connectez-vous à votre compte Katuiscia.'); ?>
...
<div class="auth-split">
  ...
  <div class="auth-image">
    <img src="<?php echo e(asset('assets/images/beaute-hero.webp')); ?>" alt="Ambiance Katuiscia" class="bg" onerror="this.style.display='none';this.nextElementSibling.style.background='linear-gradient(135deg, var(--color-warm), var(--color-dark))';">
    ...
    <div class="auth-slideshow">
      <div class="auth-slide active" data-slide="0">
        ...
        <a href="<?php echo e(url('boutique')); ?>" class="auth-slide__cta">Explorer la boutique</a>
      </div>
      <div class="auth-slide" data-slide="1">
        ...
        <a href="<?php echo e(url('formation')); ?>" class="auth-slide__cta">Découvrir les formations</a>
      </div>
      <div class="auth-slide" data-slide="2">
        ...
        <a href="<?php echo e(url('grossiste')); ?>" class="auth-slide__cta">Devenir partenaire</a>
      </div>
      <div class="auth-slide" data-slide="3">
        ...
        <a href="<?php echo e(url('inscription')); ?>" class="auth-slide__cta">Rejoindre le club</a>
      </div>
    </div>
  ...
  <div class="auth-form-container">
    ...
    <div class="auth-form fade-in-up delay-1">
      ...
      <form method="POST" action="<?php echo e(url('connexion')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-options fade-in-up delay-4">
          ...
          <a href="<?php echo e(url('mot-de-passe-oublie')); ?>" class="forgot-link">Mot de passe oublié ?</a>
        </div>
        <button type="submit" class="btn-auth fade-in-up delay-4">Se connecter</button>
      </form>

      <p class="auth-footer fade-in-up delay-5">
        Nouveau chez Katuiscia ? <a href="<?php echo e(url('inscription')); ?>">Créer un compte</a>
      </p>
    </div>
  </div>
</div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\auth\login.blade.php ENDPATH**/ ?>