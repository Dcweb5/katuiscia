<?php $__env->startSection('title', 'KATUISCIA — Beauté Botanique de Luxe'); ?>
<?php $__env->startSection('description', 'Découvrez KATUISCIA, des formulations botaniques soignées pour élever votre rituel quotidien.'); ?>
...
<section class="relative min-h-screen flex items-center pt-header overflow-hidden" id="hero">
  ...
  <div class="absolute inset-0 bg-cream z-0 pointer-events-none">
    <div class="absolute top-[15%] right-[10%] w-[450px] h-[500px] bg-warm rounded-3xl -rotate-2 hidden lg:block" data-parallax="-0.15">
    </div>
  </div>
  ...
  <div class="relative z-10 max-w-site mx-auto px-4 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    ...
    <div class="max-w-[500px] reveal-k-k">
      ...
      <div class="flex items-center gap-6 mb-10">
        <a href="<?php echo e(url('boutique')); ?>" class="btn-katuiscia">Explorer la collection</a>
      </div>
      <!-- Slide tag -->
      <div class="bg-white p-5 rounded-2xl shadow-md inline-flex flex-col gap-1 max-w-[280px]">
        ...
        <span class="font-heading text-xl font-medium text-dark transition-all duration-300" id="hero-tag-name">Nectar Lumineux</span>
        <span class="text-md font-semibold text-warm transition-all duration-300" id="hero-tag-price">125 €</span>
      </div>
    </div>
    ...
    <div class="relative flex justify-center items-center min-h-[500px] reveal-k-k delay-2" id="hero-slideshow">
      <div class="hero-slide active" data-name="Nectar Lumineux" data-price="125 €">
        <img src="<?php echo e(asset('assets/images/product-1a.webp')); ?>" alt="Nectar Lumineux"
      ...
      <div class="hero-slide" data-name="Botanique de Minuit" data-price="160 €">
        <img src="<?php echo e(asset('assets/images/product-2a.webp')); ?>" alt="Botanique de Minuit"
             class="max-w-[380px] w-full rounded-2xl shadow-xl transition-transform duration-500 ease-out-expo" width="400" height="533">
      </div>
      <div class="hero-slide" data-name="Sérum Éclat" data-price="110 €">
        <img src="<?php echo e(asset('assets/images/product-6a.webp')); ?>" alt="Sérum Éclat"
             class="max-w-[380px] w-full rounded-2xl shadow-xl transition-transform duration-500 ease-out-expo" width="400" height="533">
      </div>

      <div class="absolute -bottom-5 left-1/2 -translate-x-1/2 flex gap-2.5 z-[5]">
        <button class="hero-dot active" data-slide="0" aria-label="Produit 1"></button>
        <button class="hero-dot" data-slide="1" aria-label="Produit 2"></button>
        <button class="hero-dot" data-slide="2" aria-label="Produit 3"></button>
      </div>

      <img src="<?php echo e(asset('assets/images/product-3a.webp')); ?>" alt=""
      ...
      <img src="<?php echo e(asset('assets/images/product-4a.webp')); ?>" alt=""
...
<section class="py-24 bg-white" id="bestsellers">
  ...
  <div class="showcase-track flex overflow-x-auto lg:overflow-visible lg:justify-center gap-6 lg:gap-12 max-w-[1200px] mx-auto px-4 pb-12 snap-x snap-mandatory hide-scrollbar">
    ...
    <a href="<?php echo e(url('produit/' . $product->slug)); ?>" class="showcase-item group flex-none w-[280px] lg:w-[320px] snap-center relative flex flex-col items-center text-center transition-transform duration-300 ease-out-expo hover:-translate-y-2 reveal-k-k <?php if($loop->iteration > 1): ?> delay-<?php echo e($loop->iteration - 1); ?> <?php endif; ?>">
      <div class="w-full h-[350px] lg:h-[400px] bg-gray-med rounded-2xl flex items-center justify-center p-8 transition-colors group-hover:bg-[#E2DFD9]">
        <img src="<?php echo e(asset($product->image_primary ?: 'assets/images/product-4a.webp')); ?>" alt="<?php echo e($product->name); ?>"
      ...
      <div class="absolute -bottom-5 bg-white px-8 py-3 rounded-xl shadow-md flex flex-col min-w-[220px]">
        <span class="text-xs text-text-muted tracking-wider uppercase"><?php echo e($product->badge ?? 'TOP'); ?></span>
        <span class="font-heading text-lg font-medium text-dark"><?php echo e($product->name); ?></span>
      </div>
    </a>
  ...
  <div class="flex lg:hidden justify-center gap-2 mt-12">
    <button class="showcase-dot active" data-index="0"></button>
    <button class="showcase-dot" data-index="1"></button>
    <button class="showcase-dot" data-index="2"></button>
  </div>
</section>
...
<section class="py-24 bg-cream" id="curated">
  ...
  <div class="max-w-[1200px] mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.3fr_0.7fr_0.7fr] lg:grid-rows-2 gap-4">
    <div class="lg:row-span-2 relative rounded-xl overflow-hidden bg-white shadow-card group cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-1 reveal-k-k">
      <div class="w-full h-full overflow-hidden"><a href="<?php echo e(url('produit/' . ($featuredProducts[1]->slug ?? 'botanique-de-minuit'))); ?>" class="block w-full h-full">
        <img src="<?php echo e(asset($featuredProducts[1]->image_primary ?? 'assets/images/product-2a.webp')); ?>" alt="Botanique de Minuit"
      ...
      <div class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-dark/60 to-transparent text-white">
        <h3 class="font-heading text-xl font-medium"><?php echo e($featuredProducts[1]->name ?? 'Botanique de Minuit'); ?></h3>
        <p class="text-sm text-gray-200"><?php echo e($featuredProducts[1]->description ?? 'Essence Nocturne'); ?></p>
      </div>
      <span class="absolute top-4 right-4 bg-white text-dark text-sm font-semibold px-4 py-1.5 rounded-full"><?php echo e(number_format($featuredProducts[1]->price ?? 160, 0, ',', ' ')); ?> €</span>
    </div>
    <div class="relative rounded-xl overflow-hidden bg-white shadow-card group cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-1 reveal-k-k delay-1">
      <a href="<?php echo e(url('produit/' . ($featuredProducts[2]->slug ?? 'serum-eclat'))); ?>" class="block w-full h-[220px] overflow-hidden">
        <img src="<?php echo e(asset($featuredProducts[2]->image_primary ?? 'assets/images/product-5a.webp')); ?>" alt="Émulsion Soyeuse"
             class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy">
      </a>
      <div class="p-4 flex flex-col gap-1">
        <span class="text-xs text-text-muted tracking-wider uppercase">Soin Corps</span>
        <h3 class="font-heading text-xl font-medium text-dark"><?php echo e($featuredProducts[2]->name ?? 'Émulsion Soyeuse'); ?></h3>
        <span class="text-md font-semibold text-dark mt-1"><?php echo e(number_format($featuredProducts[2]->price ?? 95, 0, ',', ' ')); ?> €</span>
      </div>
    </div>
    <div class="relative rounded-xl overflow-hidden bg-white shadow-card group cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-1 reveal-k-k delay-2">
      <a href="<?php echo e(url('produit/' . ($featuredProducts[3]->slug ?? 'creme-velours'))); ?>" class="block w-full h-[220px] overflow-hidden">
        <img src="<?php echo e(asset($featuredProducts[3]->image_primary ?? 'assets/images/product-7a.webp')); ?>" alt="Crème Velours"
             class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy">
      </a>
      <div class="p-4 flex flex-col gap-1">
        <span class="text-xs text-text-muted tracking-wider uppercase">Soin Nuit</span>
        <h3 class="font-heading text-xl font-medium text-dark"><?php echo e($featuredProducts[3]->name ?? 'Crème Velours'); ?></h3>
        <span class="text-md font-semibold text-dark mt-1"><?php echo e(number_format($featuredProducts[3]->price ?? 145, 0, ',', ' ')); ?> €</span>
      </div>
    </div>
  </div>
  <div class="text-center mt-12 reveal-k-k"><a href="<?php echo e(url('boutique')); ?>" class="btn-katuiscia">Découvrir plus</a></div>
</section>
    ...
    <div class="product-card-k reveal-k-k delay-<?php echo e($loop->iteration); ?>">
      <div class="card-image">
        <a href="<?php echo e(url('produit/' . $product->slug)); ?>" class="block w-full h-full">
          <img src="<?php echo e(asset($product->image_primary ?: 'assets/images/product-1a.webp')); ?>" alt="<?php echo e($product->name); ?>" class="img-primary" loading="lazy">
          <img src="<?php echo e(asset($product->image_secondary ?: $product->image_primary)); ?>" alt="<?php echo e($product->name); ?> alt" class="img-secondary" loading="lazy">
        </a>
        ...
        <button class="card-cart-btn cart-add-btn" data-product-id="<?php echo e($product->id); ?>" data-quantity="1" aria-label="Ajouter au panier" style="background:none;border:none;color:inherit;cursor:pointer;padding:0;display:flex;align-items:center;justify-content:center;">
      ...
      <div class="card-info"><a href="<?php echo e(url('produit/' . $product->slug)); ?>" class="no-underline text-inherit flex-1">
        <span class="card-category">Soin de la peau</span>
        <h3 class="card-name"><?php echo e($product->name); ?></h3>
        <p class="card-desc"><?php echo e($product->description); ?></p>
        <span class="card-price"><?php echo e(number_format($product->price, 0, ',', ' ')); ?> €</span>
      </a></div>
    </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </div>
...
<section class="bg-peach overflow-hidden" id="philosophy">
  <div class="max-w-site mx-auto grid grid-cols-1 lg:grid-cols-2">
    <div class="relative min-h-[400px] lg:min-h-[600px] reveal-k-k">
      <img src="<?php echo e(asset('assets/images/editorial-main.webp')); ?>" alt="Botanique" class="absolute w-full h-full object-cover" loading="lazy">
      <img src="<?php echo e(asset('assets/images/product-5a.webp')); ?>" alt="Soin" class="absolute -bottom-5 -right-8 w-32 lg:w-40 rounded-2xl shadow-xl z-10 border-4 border-peach" loading="lazy">
    </div>
    <div class="p-12 lg:p-24 flex flex-col justify-center reveal-k-k delay-1">
      ...
      <div class="bg-white/50 backdrop-blur-sm p-6 rounded-xl flex items-center gap-6 mb-10 max-w-lg">
        <img src="<?php echo e(asset('assets/images/editorial-accent.webp')); ?>" alt="" class="w-20 h-20 rounded-lg object-cover flex-none" loading="lazy">
      ...
      <a href="<?php echo e(url('maison')); ?>" class="btn-katuiscia self-start">Découvrir nos produits</a>
    </div>
  </div>
</section>
...
<script type="module" src="<?php echo e(asset('js/index-dynamics.js')); ?>"></script>
<?php $__env->stopSection(); ?>
