<?php $__env->startSection('title', 'Beauté Responsable — KATUISCIA'); ?>
...
<main id="main-content">
    ...
    <section class="py-32 bg-peach flex flex-col items-center justify-center text-center px-4">
      <div class="max-w-4xl mx-auto reveal-k-k space-y-10">
        ...
        <a href="<?php echo e(url('valeurs-emballage-durable')); ?>" class="btn-katuiscia-filled inline-block py-4 px-10 text-sm tracking-widest uppercase font-semibold">Découvrir l'emballage durable</a>
      </div>
    </section>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\mes sites web\KATUISCIA LARAVEL\resources\views\pages\valeurs-beaute-responsable.blade.php ENDPATH**/ ?>