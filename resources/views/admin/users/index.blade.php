...
<div class="dashboard-content">
  ...
  <div class="filter-pills">
    ...
    @include('components.date-filter', ['formId' => 'users-filter'])
        ...
        <tr>
          ...
          <td>
            <div style="display:flex;gap:4px;flex-wrap:wrap;">
              ...
              @if(auth()->id() !== $user->id)
              <form method="POST" action="{{ route('admin.users.destroy', $user) }}" onsubmit="event.preventDefault();showConfirm('Supprimer cet utilisateur définitivement ?',()=>this.submit())" style="display:inline;">
                @csrf @method('DELETE')
