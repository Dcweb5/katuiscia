        ...
        <div class="card" style="margin-bottom:var(--space-xl);">
          ...
          <div style="display:grid; grid-template-columns:repeat(auto-fill, minmax(200px, 1fr)); gap:var(--space-md);">
            <div style="border:2px solid var(--color-warm); border-radius:var(--radius-md); overflow:hidden; position:relative;">
              <img src="{{ asset('assets/images/product-1a.png') }}" alt="" style="width:100%; height:160px; object-fit:cover;">
            ...
            <div style="border:2px solid var(--color-warm); border-radius:var(--radius-md); overflow:hidden; position:relative;">
              <img src="{{ asset('assets/images/product-6a.png') }}" alt="" style="width:100%; height:160px; object-fit:cover;">
            ...
            <div style="border:2px solid var(--color-warm); border-radius:var(--radius-md); overflow:hidden; position:relative;">
              <img src="{{ asset('assets/images/product-3a.png') }}" alt="" style="width:100%; height:160px; object-fit:cover;">
