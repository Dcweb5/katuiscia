    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr] gap-12 lg:gap-16">
      ...
      <div>
        <div class="mb-4 relative w-[366px] h-[60px] overflow-hidden max-w-full">
          <a href="{{ url('/') }}" class="block w-full h-full">
            <img src="{{ asset('assets/images/K LOGO.png') }}" alt="KATUISCIA"
      ...
      <div>
        ...
        <div class="flex flex-col gap-3">
          <a href="{{ url('boutique') }}" class="text-sm text-text-light hover:text-dark transition-colors">Boutique</a>
          <a href="{{ url('maison') }}" class="text-sm text-text-light hover:text-dark transition-colors">À propos</a>
          <a href="{{ url('contact') }}" class="text-sm text-text-light hover:text-dark transition-colors">Contact</a>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="flex flex-col gap-3">
          <a href="{{ url('valeurs-beaute-responsable') }}" class="text-sm text-text-light hover:text-dark transition-colors">Durabilité</a>
          <a href="{{ url('politique-expedition') }}" class="text-sm text-text-light hover:text-dark transition-colors">Expédition</a>
          <a href="{{ url('politique-remboursement') }}" class="text-sm text-text-light hover:text-dark transition-colors">Retours</a>
          <a href="{{ url('suivi-commande') }}" class="text-sm text-text-light hover:text-dark transition-colors">Suivi de commande</a>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="flex flex-col gap-3">
          <a href="{{ url('mentions-legales') }}" class="text-sm text-text-light hover:text-dark transition-colors">Mentions légales</a>
          <a href="{{ url('politique-confidentialite') }}" class="text-sm text-text-light hover:text-dark transition-colors">Confidentialité</a>
          <a href="{{ url('contact') }}" class="text-sm text-text-light hover:text-dark transition-colors">Contact</a>
        </div>
      </div>
    </div>
