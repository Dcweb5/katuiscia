...
<aside class="dashboard-sidebar" id="sidebar">
  <div class="sidebar-header">
    <a href="{{ url('compte') }}" style="display:flex; align-items:center; text-decoration:none;">
      <img src="{{ asset('assets/images/K LOGO.png') }}" alt="Katuiscia" class="sidebar-logo-full">
      <img src="{{ asset('assets/images/K ICONE.png') }}" alt="K" class="sidebar-logo-icon-mobile">
    </a>
  </div>
  
  <nav class="sidebar-nav">
    <a href="{{ url('compte') }}" class="sidebar-link" data-page="compte">
    ...
    <a href="{{ url('compte/commandes') }}" class="sidebar-link" data-page="compte-commandes">
    ...
    <a href="{{ url('compte/retours') }}" class="sidebar-link" data-page="compte-retours">
    ...
    <a href="{{ url('compte/recompenses') }}" class="sidebar-link" data-page="compte-recompenses">
    ...
    <a href="{{ url('compte/avis') }}" class="sidebar-link" data-page="compte-avis">
  ...
  <div class="sidebar-footer">
    ...
    <div class="sidebar-admin-badge">
      <div class="sidebar-admin-avatar" style="background:var(--color-warm);">
        {{ substr(Auth::user()->firstname ?? 'U', 0, 1) }}{{ substr(Auth::user()->lastname ?? '', 0, 1) }}
      </div>
      <div class="sidebar-admin-info">
        <span class="sidebar-admin-name">{{ Auth::user()->firstname ?? '' }} {{ Auth::user()->lastname ?? '' }}</span>
        <span class="sidebar-admin-role">✨ {{ number_format(Auth::user()->loyalty_points ?? 0, 0, ',', ' ') }} pts</span>
      </div>
    </div>
  </div>
</aside>
