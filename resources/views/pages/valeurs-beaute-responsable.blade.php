      ...
      <div class="max-w-site mx-auto px-4 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div class="reveal-k-k delay-1">
            <img src="{{ asset('assets/images/biodiv-hero.png') }}" alt="Femme appliquant un soin KATUISCIA" class="w-full h-[400px] md:h-[500px] object-cover rounded-2xl shadow-xl">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-24 bg-dark text-white">
      <div class="max-w-site mx-auto px-4 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div class="reveal-k-k delay-1">
            <img src="{{ asset('assets/images/emballage-hero.png') }}" alt="Feuilles botaniques et nature" class="w-full h-[400px] md:h-[500px] object-cover rounded-2xl shadow-xl">
          </div>
        </div>
